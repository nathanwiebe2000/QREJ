...
Since the process is heralded and the initial state preparation process is unitary, amplitude amplification can be used to reduce the expected number of calls to the oracles quadratically~\cite{BHM+02}.  Thus the average number of queries is in $O(\sqrt{\Gamma_E/\langle P(x), P(E|x)\rangle})$
}
...
\newblock {\em Science}, 273:1073--1077, 1996.
...
\newblock In {\em Proceedings of the thirty-fifth annual ACM symposium on
  Theory of computing}, pages 59--68. ACM, 2003.
...
\bibitem{aaronson_learnability_2007}
Scott Aaronson.
\newblock The learnability of quantum states.
\newblock {\em Proceedings of the Royal Society A: Mathematical, Physical and
  Engineering Science}, 463(2088):3089--3114, December 2007.

\bibitem{granade_robust_2012}
Christopher~E Granade, Christopher Ferrie, Nathan Wiebe, and D~G Cory.
\newblock Robust online {{Hamiltonian}} learning.
\newblock {\em New Journal of Physics}, 14(10):103013, October 2012.

\bibitem{ferrie_likelihood-free_2014}
Christopher Ferrie and Christopher~E. Granade.
\newblock Likelihood-free methods for quantum parameter estimation.
\newblock {\em Physical Review Letters}, 112(13):130402, April 2014.

\bibitem{aimeur2006machine}
Esma A{\"\i}meur, Gilles Brassard, and S{\'e}bastien Gambs.
\newblock Machine learning in a quantum world.
\newblock In {\em Advances in Artificial Intelligence}, pages 431--442.
  Springer, 2006.

\bibitem{wiebe_quantum_2014}
Nathan Wiebe, Ashish Kapoor, and Krysta~M Svore.
\newblock Quantum deep learning.
\newblock {\em arXiv preprint arXiv:1412.3489}, 2014.
...
\newblock {\em arXiv preprint arXiv:1401.2142}, 2014.
...
\newblock {\em Nature Physics}, 10(9):631--633, 2014.

\bibitem{boixo2015fast}
Sergio Boixo, Gerardo Ortiz, and Rolando Somma.
\newblock Fast quantum methods for optimization.
\newblock {\em The European Physical Journal Special Topics}, 224(1):35--49,
  2015.

\bibitem{LYC14}
Guang~Hao Low, Theodore~J Yoder, and Isaac~L Chuang.
\newblock Quantum inference on bayesian networks.
\newblock {\em Physical Review A}, 89(6):062315, 2014.

\bibitem{ORR13}
Maris Ozols, Martin Roetteler, and J{\'e}r{\'e}mie Roland.
\newblock Quantum rejection sampling.
\newblock {\em ACM Transactions on Computation Theory (TOCT)}, 5(3):11, 2013.
...
\bibitem{BGH+96}
Michel Boyer, Gilles Brassard, Peter H{\o}yer, and Alain Tapp.
\newblock Tight bounds on quantum searching.
\newblock {\em arXiv preprint quant-ph/9605034}, 1996.

\bibitem{dagum1993approximating}
Paul Dagum and Michael Luby.
\newblock Approximating probabilistic inference in bayesian belief networks is
  {NP}-hard.
\newblock {\em Artificial Intelligence}, 60(1):141--153, 1993.

\bibitem{liu_combined_2001}
Jane Liu and Mike West.
\newblock Combined parameter and state estimation in simulation-based
  filtering.
\newblock In De~Freitas and NJ~Gordon, editors, {\em Sequential Monte Carlo
...
\bibitem{van2000unscented}
Rudolph Van Der~Merwe, Arnaud Doucet, Nando De~Freitas, and Eric Wan.
\newblock The unscented particle filter.
\newblock In {\em NIPS}, pages 584--590, 2000.

\bibitem{GR02}
Lov Grover and Terry Rudolph.
\newblock Creating superpositions that correspond to efficiently integrable
  probability distributions.
\newblock {\em arXiv preprint quant-ph/0208112}, 2002.

\bibitem{scarani2005quantum}
Valerio Scarani, Sofyan Iblisdir, Nicolas Gisin, and Antonio Acin.
\newblock Quantum cloning.
\newblock {\em Reviews of Modern Physics}, 77(4):1225, 2005.

\bibitem{aharonov2006polynomial}
Dorit Aharonov, Vaughan Jones, and Zeph Landau.
\newblock A polynomial quantum algorithm for approximating the jones
  polynomial.
\newblock In {\em Proceedings of the thirty-eighth annual ACM symposium on
  Theory of computing}, pages 427--436. ACM, 2006.

\bibitem{wiebe2015bayesian}
Nathan Wiebe, Christopher Granade, Ashish Kapoor, and Krysta~M Svore.
\newblock Bayesian inference via rejection filtering.
\newblock {\em arXiv preprint arXiv:1511.06458}, 2015.

\bibitem{WHW15}
Dave Wecker, Matthew~B Hastings, Nathan Wiebe, Bryan~K Clark, Chetan Nayak, and
  Matthias Troyer.
\newblock Solving strongly correlated electron models on a quantum computer.
\newblock {\em arXiv preprint arXiv:1506.05135}, 2015.

\bibitem{yoder2014fixed}
Theodore~J Yoder, Guang~Hao Low, and Isaac~L Chuang.
\newblock Fixed-point quantum search with an optimal number of queries.
\newblock {\em Physical review letters}, 113(21):210501, 2014.

\bibitem{isard_condensationconditional_1998}
Michael Isard and Andrew Blake.
\newblock {CONDENSATION}—{Conditional} {Density} {Propagation} for {Visual}
  {Tracking}.
\newblock {\em International Journal of Computer Vision}, 29(1):5--28, August
  1998.

\bibitem{BHT+00}
Gilles Brassard, Peter Hoyer, Michele Mosca, and Alain Tapp.
\newblock Quantum amplitude amplification and estimation.
\newblock {\em arXiv preprint quant-ph/0005055}, 2000.

\bibitem{WGF+14}
Nathan Wiebe, Christopher Granade, Christopher Ferrie, and DG~Cory.
\newblock Hamiltonian learning and certification using quantum resources.
\newblock {\em Physical Review Letters}, 112(19):190501, 2014.
