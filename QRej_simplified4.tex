...
While the performance advantages yielded by our algorithm suggest that approximate Bayesian inference may be a compelling application for quantum computation, the conceptual insight that this work provides into the nature of quantum learning is perhaps the most important aspect here.  Perhaps the biggest insight is that careful thought is needed to define what learning means for quantum systems.  Answering this question may not only shed light on the structure of quantum machine learning algorithms, but also may lead to a deeper understanding of the nature of inference and measurement.
